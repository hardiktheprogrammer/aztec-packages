...
struct BlackBoxFuncCall {
  ...
  struct VariableBaseScalarMul {
    ...
    friend bool operator==(const VariableBaseScalarMul &,
                           const VariableBaseScalarMul &);
    std::vector<uint8_t> bincodeSerialize() const;
  ...
  struct RecursiveAggregation {
    ...
    friend bool operator==(const RecursiveAggregation &,
                           const RecursiveAggregation &);
    std::vector<uint8_t> bincodeSerialize() const;
  ...
  struct BigIntFromLeBytes {
    ...
    friend bool operator==(const BigIntFromLeBytes &,
  ...
  struct Poseidon2Permutation {
    ...
    friend bool operator==(const Poseidon2Permutation &,
                           const Poseidon2Permutation &);
    std::vector<uint8_t> bincodeSerialize() const;
  ...
  struct Sha256Compression {
    ...
    friend bool operator==(const Sha256Compression &,
                           const Sha256Compression &);
    std::vector<uint8_t> bincodeSerialize() const;
    static Sha256Compression bincodeDeserialize(std::vector<uint8_t>);
  };

  std::variant<AND, XOR, RANGE, SHA256, Blake2s, Blake3, SchnorrVerify,
               PedersenCommitment, PedersenHash, EcdsaSecp256k1, EcdsaSecp256r1,
               MultiScalarMul, VariableBaseScalarMul, EmbeddedCurveAdd,
               Keccak256, Keccakf1600, RecursiveAggregation, BigIntAdd,
               BigIntSub, BigIntMul, BigIntDiv, BigIntFromLeBytes,
               BigIntToLeBytes, Poseidon2Permutation, Sha256Compression>
      value;
...
struct Expression {
  std::vector<std::tuple<std::string, Program::Witness, Program::Witness>>
      mul_terms;
...
struct Opcode {
  ...
  std::variant<AssertZero, BlackBoxFuncCall, Directive, MemoryOp, MemoryInit,
               BrilligCall, Call>
      value;
...
struct BinaryFieldOp {
  ...
  std::variant<Add, Sub, Mul, Div, IntegerDiv, Equals, LessThan, LessThanEquals>
      value;
...
struct BinaryIntOp {
  ...
  std::variant<Add, Sub, Mul, Div, Equals, LessThan, LessThanEquals, And, Or,
               Xor, Shl, Shr>
      value;
...
struct BlackBoxOp {
  ...
  std::variant<Sha256, Blake2s, Blake3, Keccak256, Keccakf1600, EcdsaSecp256k1,
               EcdsaSecp256r1, SchnorrVerify, PedersenCommitment, PedersenHash,
               MultiScalarMul, VariableBaseScalarMul, EmbeddedCurveAdd,
               BigIntAdd, BigIntSub, BigIntMul, BigIntDiv, BigIntFromLeBytes,
               BigIntToLeBytes, Poseidon2Permutation, Sha256Compression>
      value;
...
struct Circuit {
  ...
  std::vector<std::tuple<Program::OpcodeLocation, Program::AssertionPayload>>
      assert_messages;
  bool recursive;
...
inline AssertionPayload
AssertionPayload::bincodeDeserialize(std::vector<uint8_t> input) {
...
AssertionPayload::StaticString::bincodeDeserialize(std::vector<uint8_t> input) {
  auto deserializer = serde::BincodeDeserializer(input);
  auto value =
...
inline bool operator==(const BlackBoxFuncCall::SHA256 &lhs,
...
inline BlackBoxFuncCall::SHA256
BlackBoxFuncCall::SHA256::bincodeDeserialize(std::vector<uint8_t> input) {
  auto deserializer = serde::BincodeDeserializer(input);
  auto value = serde::Deserializable<BlackBoxFuncCall::SHA256>::deserialize(
      deserializer);
  if (deserializer.get_buffer_offset() < input.size()) {
    throw serde::deserialization_error("Some input bytes were not read");
  }
...
template <>
template <typename Serializer>
void serde::Serializable<Program::BlackBoxFuncCall::SHA256>::serialize(
    const Program::BlackBoxFuncCall::SHA256 &obj, Serializer &serializer) {
...
template <>
template <typename Deserializer>
Program::BlackBoxFuncCall::SHA256
serde::Deserializable<Program::BlackBoxFuncCall::SHA256>::deserialize(
    Deserializer &deserializer) {
...
inline bool operator==(const BlackBoxFuncCall::MultiScalarMul &lhs,
...
inline std::vector<uint8_t>
BlackBoxFuncCall::MultiScalarMul::bincodeSerialize() const {
  auto serializer = serde::BincodeSerializer();
  serde::Serializable<BlackBoxFuncCall::MultiScalarMul>::serialize(*this,
                                                                   serializer);
  return std::move(serializer).bytes();
}

inline BlackBoxFuncCall::MultiScalarMul
BlackBoxFuncCall::MultiScalarMul::bincodeDeserialize(
    std::vector<uint8_t> input) {
  auto deserializer = serde::BincodeDeserializer(input);
  auto value =
      serde::Deserializable<BlackBoxFuncCall::MultiScalarMul>::deserialize(
          deserializer);
  if (deserializer.get_buffer_offset() < input.size()) {
    throw serde::deserialization_error("Some input bytes were not read");
  }
...
void serde::Serializable<Program::BlackBoxFuncCall::MultiScalarMul>::serialize(
    const Program::BlackBoxFuncCall::MultiScalarMul &obj,
    Serializer &serializer) {
...
template <>
template <typename Deserializer>
Program::BlackBoxFuncCall::MultiScalarMul
serde::Deserializable<Program::BlackBoxFuncCall::MultiScalarMul>::deserialize(
    Deserializer &deserializer) {
...
inline std::vector<uint8_t>
BlackBoxFuncCall::VariableBaseScalarMul::bincodeSerialize() const {
  auto serializer = serde::BincodeSerializer();
  serde::Serializable<BlackBoxFuncCall::VariableBaseScalarMul>::serialize(
      *this, serializer);
  return std::move(serializer).bytes();
}

inline BlackBoxFuncCall::VariableBaseScalarMul
BlackBoxFuncCall::VariableBaseScalarMul::bincodeDeserialize(
    std::vector<uint8_t> input) {
  auto deserializer = serde::BincodeDeserializer(input);
  auto value = serde::Deserializable<
      BlackBoxFuncCall::VariableBaseScalarMul>::deserialize(deserializer);
  if (deserializer.get_buffer_offset() < input.size()) {
    throw serde::deserialization_error("Some input bytes were not read");
  }
  return value;
...
template <>
template <typename Serializer>
void serde::Serializable<Program::BlackBoxFuncCall::VariableBaseScalarMul>::
    serialize(const Program::BlackBoxFuncCall::VariableBaseScalarMul &obj,
              Serializer &serializer) {
  serde::Serializable<decltype(obj.point_x)>::serialize(obj.point_x,
                                                        serializer);
  serde::Serializable<decltype(obj.point_y)>::serialize(obj.point_y,
                                                        serializer);
  serde::Serializable<decltype(obj.scalar_low)>::serialize(obj.scalar_low,
                                                           serializer);
  serde::Serializable<decltype(obj.scalar_high)>::serialize(obj.scalar_high,
                                                            serializer);
  serde::Serializable<decltype(obj.outputs)>::serialize(obj.outputs,
                                                        serializer);
}
...
template <>
template <typename Deserializer>
Program::BlackBoxFuncCall::VariableBaseScalarMul
serde::Deserializable<Program::BlackBoxFuncCall::VariableBaseScalarMul>::
    deserialize(Deserializer &deserializer) {
  Program::BlackBoxFuncCall::VariableBaseScalarMul obj;
  obj.point_x =
      serde::Deserializable<decltype(obj.point_x)>::deserialize(deserializer);
  obj.point_y =
      serde::Deserializable<decltype(obj.point_y)>::deserialize(deserializer);
  obj.scalar_low = serde::Deserializable<decltype(obj.scalar_low)>::deserialize(
      deserializer);
  obj.scalar_high =
      serde::Deserializable<decltype(obj.scalar_high)>::deserialize(
          deserializer);
  obj.outputs =
      serde::Deserializable<decltype(obj.outputs)>::deserialize(deserializer);
  return obj;
...
inline bool operator==(const BlackBoxOp::Sha256 &lhs,
...
inline BlackBoxOp::Sha256
BlackBoxOp::Sha256::bincodeDeserialize(std::vector<uint8_t> input) {
  auto deserializer = serde::BincodeDeserializer(input);
  auto value =
      serde::Deserializable<BlackBoxOp::Sha256>::deserialize(deserializer);
  if (deserializer.get_buffer_offset() < input.size()) {
    throw serde::deserialization_error("Some input bytes were not read");
  }
  return value;
...
template <>
template <typename Serializer>
void serde::Serializable<Program::BlackBoxOp::Sha256>::serialize(
    const Program::BlackBoxOp::Sha256 &obj, Serializer &serializer) {
  serde::Serializable<decltype(obj.message)>::serialize(obj.message,
                                                        serializer);
  serde::Serializable<decltype(obj.output)>::serialize(obj.output, serializer);
}
...
template <>
template <typename Deserializer>
Program::BlackBoxOp::Sha256
serde::Deserializable<Program::BlackBoxOp::Sha256>::deserialize(
    Deserializer &deserializer) {
...
inline bool operator==(const BlackBoxOp::MultiScalarMul &lhs,
...
inline std::vector<uint8_t>
BlackBoxOp::MultiScalarMul::bincodeSerialize() const {
  auto serializer = serde::BincodeSerializer();
  serde::Serializable<BlackBoxOp::MultiScalarMul>::serialize(*this, serializer);
  return std::move(serializer).bytes();
}

inline BlackBoxOp::MultiScalarMul
BlackBoxOp::MultiScalarMul::bincodeDeserialize(std::vector<uint8_t> input) {
  auto deserializer = serde::BincodeDeserializer(input);
  auto value = serde::Deserializable<BlackBoxOp::MultiScalarMul>::deserialize(
      deserializer);
  if (deserializer.get_buffer_offset() < input.size()) {
    throw serde::deserialization_error("Some input bytes were not read");
  }
...
template <>
template <typename Serializer>
void serde::Serializable<Program::BlackBoxOp::MultiScalarMul>::serialize(
    const Program::BlackBoxOp::MultiScalarMul &obj, Serializer &serializer) {
  serde::Serializable<decltype(obj.low)>::serialize(obj.low, serializer);
  serde::Serializable<decltype(obj.high)>::serialize(obj.high, serializer);
  serde::Serializable<decltype(obj.result)>::serialize(obj.result, serializer);
}
...
template <>
template <typename Deserializer>
Program::BlackBoxOp::MultiScalarMul
serde::Deserializable<Program::BlackBoxOp::MultiScalarMul>::deserialize(
    Deserializer &deserializer) {
...
inline bool operator==(const BlackBoxOp::VariableBaseScalarMul &lhs,
                       const BlackBoxOp::VariableBaseScalarMul &rhs) {
  if (!(lhs.point_x == rhs.point_x)) {
    return false;
  }
  if (!(lhs.point_y == rhs.point_y)) {
...
inline std::vector<uint8_t>
BlackBoxOp::VariableBaseScalarMul::bincodeSerialize() const {
  auto serializer = serde::BincodeSerializer();
  serde::Serializable<BlackBoxOp::VariableBaseScalarMul>::serialize(*this,
                                                                    serializer);
  return std::move(serializer).bytes();
}

inline BlackBoxOp::VariableBaseScalarMul
BlackBoxOp::VariableBaseScalarMul::bincodeDeserialize(
    std::vector<uint8_t> input) {
  auto deserializer = serde::BincodeDeserializer(input);
  auto value =
      serde::Deserializable<BlackBoxOp::VariableBaseScalarMul>::deserialize(
          deserializer);
  if (deserializer.get_buffer_offset() < input.size()) {
    throw serde::deserialization_error("Some input bytes were not read");
  }
...
void serde::Serializable<Program::BlackBoxOp::VariableBaseScalarMul>::serialize(
    const Program::BlackBoxOp::VariableBaseScalarMul &obj,
    Serializer &serializer) {
  serde::Serializable<decltype(obj.point_x)>::serialize(obj.point_x,
                                                        serializer);
  serde::Serializable<decltype(obj.point_y)>::serialize(obj.point_y,
...
template <>
template <typename Deserializer>
Program::BlackBoxOp::VariableBaseScalarMul
serde::Deserializable<Program::BlackBoxOp::VariableBaseScalarMul>::deserialize(
    Deserializer &deserializer) {
